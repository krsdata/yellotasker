                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="alert alert-success display-hide">
										 	...
										 	<div class="form-group <?php echo e($errors->first('first_name', ' has-error')); ?>">
										        ...
										        <div class="col-md-4"> 
										            <?php echo Form::text('first_name',null, ['class' => 'form-control','data-required'=>1]); ?> 
									        ...
									        <div class="col-md-4"> 
									            <?php echo Form::password('password', ['class' => 'form-control','data-required'=>1]); ?> 
                                        ...
                                        <div class="form-group <?php echo e($errors->first('role', ' has-error')); ?>">
        ...
        <div class="col-md-offset-3 col-md-9">
           <div class="col-md-2">
            ...
            <div class="col-md-2">    
                ...
                <?php echo Form::button('Back', ['class'=>'btn btn-warning col-md-12 text-white']); ?> </a>
            </div>            
        </div>
    </div>
</div>
