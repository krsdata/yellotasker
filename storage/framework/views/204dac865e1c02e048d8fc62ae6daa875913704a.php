                    ...
                    <ul class="page-sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item start active">
                         ...
                         <li class="nav-item start active <?php echo e((isset($page_title) && $page_title=='Program')?'open':''); ?>">
                            ...
                            <!-- Post task ------>
                        <li class="nav-item  start active  <?php echo e((isset($viewPage) && $viewPage=='Post Task')?'open':''); ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                     <i class="glyphicon glyphicon-user"></i>
                                    <span class="title">Task Management</span>
                                    <span class="arrow <?php echo e((isset($viewPage) && $viewPage=='Post Task')?'open':''); ?>"></span>
                                </a>

                            <ul class="sub-menu" style="display: <?php echo e((isset($viewPage) && $viewPage=='Post Task')?'block':'none'); ?>">
                                ...
                                <li class="nav-item  <?php echo e((isset($page_title) && $page_title=='comment')?'open':''); ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="icon-user"></i>
                                    <span class="title">Comment</span>
                                    <span class="arrow <?php echo e((isset($page_title) && $page_title=='comment')?'open':''); ?>"></span>
                                </a>
                                    <ul class="sub-menu" style="display: <?php echo e((isset($page_title) && $page_title=='comment')?'block':'none'); ?>">
                                         <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='comment')?'active':''); ?>">
                         ...
                         <li class="nav-item start active <?php echo e((isset($page_title) && $page_title=='Program')?'open':''); ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    ...
                                    <span class="arrow <?php echo e((isset($page_title) && $page_title=='Reason')?'open':''); ?>"></span>
                                </a>
                                <ul class="sub-menu" style="display: <?php echo e((isset($page_title) && $page_title=='Reason')?'block':'none'); ?>">
                                    <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='View Program')?'active':''); ?>">
                                        <a href="<?php echo e(route('reason')); ?>" class="nav-link ">
                                           <i class="glyphicon glyphicon-eye-open"></i> 
                                            <span class="title">
                                                View Reason 
                                            </span>
                                    ...
                                    <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='Create Reason')?'active':''); ?>">
                                        <a href="<?php echo e(route('reason.create')); ?>" class="nav-link ">
                                           <i class="glyphicon glyphicon-plus-sign"></i> 
                                            <span class="title">
                                                Create Reason 
                                            </span>
