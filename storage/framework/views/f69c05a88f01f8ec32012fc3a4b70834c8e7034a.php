                      ...
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <?php echo Form::model($reason, ['method' => 'PATCH', 'route' => ['reason.update', $reason->id],'class'=>'form-horizontal user-form','id'=>'form_sample_3','enctype'=>'multipart/form-data']); ?>

                                    <?php echo $__env->make('packages::reason.form', compact('reason'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::close(); ?> 
                                    <!-- END FORM-->
                                </div>
