                            ...
                            <div class="portlet light portlet-fit bordered">
                                    ...
                                    <div class="caption">
                                     ...
                                     <div class="col-md-2 pull-right">
                                            <div style="width: 150px;" class="input-group"> 
                                                <a href="<?php echo e(route('reason.create')); ?>">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <form action="<?php echo e(route('reason')); ?>" method="get" id="filter_data">
                                         ...
                                         <div class="col-md-2">
                                             <a href="<?php echo e(route('reason')); ?>">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="contact">
                                        ...
                                        <tbody>
                                        <?php foreach($reasons as $key => $result): ?>
                                            <tr>
                                             <th>  <?php echo e(++$key); ?> </th>
                                                <td> <?php echo e($result->reasonType); ?> </td>
                                                 <td> <?php echo e($result->reasonDescription); ?> </td> 
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('reason.edit',$result->id)); ?>">
                                                            <i class="fa fa-edit" title="edit"></i> 
                                                        </a>

                                                        <?php echo Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('reason.destroy', $result->id))); ?>
                                    ...
                                    <span>
                                     ...
                                     <div class="center" align="center">  <?php echo $reasons->appends(['search' => isset($_GET['search'])?$_GET['search']:''])->render(); ?></div>
                                </div>
                            </div>
