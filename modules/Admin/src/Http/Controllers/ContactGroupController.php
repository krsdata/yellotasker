...
class ContactGroupController extends Controller {
    ...
    { 
        ...
        $contacts = Contact::with('contactGroup')->orderBy('id','desc')->get();
        dd($contacts);

        return view('packages::contactGroup.index', compact('contactGroupPag','contactGroup','data', 'page_title', 'page_action','sub_page_title','contacts'));
    }
